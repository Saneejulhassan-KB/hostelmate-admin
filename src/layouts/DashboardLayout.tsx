...
export const DashboardLayout = () => {
  ...
  return (
    <div className="flex min-h-screen w-full bg-background">
      ...
      {/* Mobile Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 transform bg-card border-r border-border transition-transform duration-300 ease-in-out lg:hidden ${
